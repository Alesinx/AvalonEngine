...
namespace Avalon
{
	ImGuiKey ImguiOverlay::ImGui_ImplGlfw_KeyToImGuiKey(int key)
	{
		switch (key)
		{
	...
	bool ImguiOverlay::OnMouseMovedEvent(MouseMovedEvent& e)
	{
		ImGuiIO& io = ImGui::GetIO();
	...
	bool ImguiOverlay::OnMouseScrolledEvent(MouseScrolledEvent& e)
	{
		ImGuiIO& io = ImGui::GetIO();
	...
	bool ImguiOverlay::OnKeyPressedEvent(KeyPressedEvent& e)
	{
		ImGuiIO& io = ImGui::GetIO();
	...
	bool ImguiOverlay::OnKeyReleasedEvent(KeyReleasedEvent& e)
	{
		ImGuiIO& io = ImGui::GetIO();
		ImGuiKey imgui_key = ImGui_ImplGlfw_KeyToImGuiKey(e.GetKeyCode());
	...
	bool ImguiOverlay::OnKeyTypedEvent(KeyTypedEvent& e)
	{
		ImGuiIO& io = ImGui::GetIO();
