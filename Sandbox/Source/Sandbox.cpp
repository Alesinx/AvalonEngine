...
void Sandbox::SetupTriangle()
{
	...
	std::shared_ptr<Avalon::Shader> triangleShader = Avalon::Shader::Create(vertexSrc, fragmentSrc);
...
void Sandbox::SetupGrid()
{
	...
	std::shared_ptr<Avalon::Shader> blueShader = Avalon::Shader::Create(blueShaderVertexSrc, blueShaderFragmentSrc);
